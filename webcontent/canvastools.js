...
(function($) {
	...
	CanvasTools.prototype.drawCross = function() {
		//this.ctx.drawImage(document.getElementById)
		this.ctx.moveTo(0, 0);
	...
	CanvasTools.prototype.onMouseDown = function(e) {
		...
		self._latestMouseDownCoord = [e.layerX, e.layerY];
	};
	
	CanvasTools.prototype.onMouseUp = function(e) {
		e.data._onMouseUp(e.layerX, e.layerY);
	};
	...
	CanvasTools.prototype.onMouseOver = function(e) {
		var self = e.data._onMouseOver(e.layerX, e.layerY);
	};
